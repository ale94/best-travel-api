...
public class ReservationController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ReservationResponse> put(@RequestBody ReservationRequest request,
    ...
    public ResponseEntity<Map<String, BigDecimal>> getHotelPrice(@RequestParam Long hotelId) {
        return ResponseEntity.ok(
            Collections.singletonMap("hotelPrice", this.reservationService.findPrice(hotelId)));
    }
